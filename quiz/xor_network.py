...
[ Perceptron([1, 1], 0), Perceptron([0.6, 0.6], 1), Perceptron([1, 1], 0) ], \
...
def EvalNetwork(inputValues, Network):
    ...
    # YOUR CODE HERE
    layer_0_output = np.array([p.activate(inputValues) for p in Network[0]])

    OutputValue = [p.activate(layer_0_output) for p in Network[1]]
